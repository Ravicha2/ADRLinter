...
Symbolic resolution per ADR 008:
  ADR text -> langextract -> SymbolicConstraint -> ADG traversal + substring
  matching -> ResolvedConstraint -> ConstraintEdge -> merge
"""
...
# ---------------------------------------------------------------------------
# Symbolic resolution helpers (ADR 008)
# ---------------------------------------------------------------------------
...
def _resolve_side(
    ...
    if general_matches:
        ...
        # All modules under the general match
...
def resolve_symbolic_constraints(
    ...
    for sc in symbolic:
        ...
        # Build wildcard pattern from matched nodes
        # If multiple subject nodes match, produce one wildcard ConstraintEdge
        # covering all of them. If one match, produce an exact edge.
        ...
        # If this produces too many edges, add grouping later.
